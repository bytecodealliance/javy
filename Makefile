...
test-apis:
	cargo wasi test --package=javy-apis --features console,stream_io -- --nocapture
...
fmt-apis:
	...
	cargo clippy --package=javy-apis --features console,stream_io --target=wasm32-wasi --all-targets -- -D warnings
